          ...
          <ContentSection>
            <Reveal>
              <ImageTextBlock
                ...
                content="Mzizi means root in Swahili, and that single word is the whole idea.\n\nLook inside most bathroom cabinets and you will find the same story: half-used growth oils, gut powders, detox teas, a shampoo that was going to change everything. Tens of products tried — and hair and skin no better than a year ago. People are not failing; they are being sold hope instead of results.\n\nLong before laboratories and marketing, people cared for their hair and bodies with plants they could name — rosemary for the scalp, castor for the strand, amla for the root — and it worked, because the plant was whole and unadulterated.\n\nWe went back to those ways and refused every shortcut that dulls them: cold-pressed, single-origin botanicals, and nothing added to bulk out a bottle. Nothing ships until it works — and what works, we sell.\n\nOwn your story."
                imagePosition="left"
              />
            </Reveal>
          </ContentSection>
